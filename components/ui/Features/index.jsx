    ...
    const features = [
        {
            ...
            title: "Comptitors Report",
            desc: "With weekly and/or monthly statistics, you can keep track of your comptitors."
        },
        {
            icon:
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            title: "A powerful and flexible UI",
            desc: "Our UI make the use and search more easy"
        },
        {
            icon:
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            desc: "We guarantee that your data data will never be shared or sold to a third party."
        },
        {
            icon:
            ...
            desc: "we help you understand how well your market"
        },
    ]
            ...
            <div className="custom-screen text-gray-300 justify-between gap-24 lg:flex">
                <div className="max-w-xl">
                    <h2 className="text-white text-3xl font-semibold sm:text-4xl">
                        make your Business in front of more people
                    </h2>
                    <p className="mt-3">
                        Hudhud is a new, revolutionary way to generate comptitors. We offer a variety of packages to suit your needs.
                    </p>
                </div>
