...
const Pricing = () => {
    ...
    const plans = [
        {
            name: "Basic plan",
            desc: "basic find comptitors",
            price: 10,
            isMostPop: false,
            features: [
                "3 free analyses",
                "Access to competitors' list",
                "1000 words per report",
                "links to websites",
                "find good comptitors",
                "good content ",
        ...
        },
        {
            ...
            isMostPop: true,
            features: [
                "basic plan features+12",
                "Access to competitors' list",
                "2500 words per report",
                "SWOT Analysis",
                "find perfect comptitors",
                "perfect content ",
            ],
        },
        {
            name: "Gold plan",
            desc: "All Premium plan features and more",
            price: 50,
            isMostPop: false,
            features: [
                "Unlimited Analysis",
                "Data Visulization",
                "35,000 words per report",
                "Priority customer support 24/",
                "ind Ideal comptitors",
                "Great content",
            ],
        },
    ];
